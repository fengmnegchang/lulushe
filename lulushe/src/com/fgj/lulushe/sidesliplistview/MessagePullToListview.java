...
/**
 *@author sunShine
 *@version 创建时间：2015-1-21 下午4:00:40 
 *@description 
 */

public class MessagePullToListview extends ListView implements OnScrollListener {
	 ...
	 * @description 是否支持上拉 
	 */
	private boolean isSupportBottom = false;
     
	public MessagePullToListview(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
