...
public class DatePicker extends LinearLayout {
	...
	private void init(Context context){
		...
		LayoutParams lparams_hours = new LayoutParams(mWidth*2,LayoutParams.WRAP_CONTENT);
		lparams_hours.setMargins(0, 0, 20, 0);
		years.setLayoutParams(lparams_hours);
		years.setAdapter(new NumericWheelAdapter(currentyear, currentyear+1));
		years.setVisibleItems(3);
		years.addChangingListener(onYearsChangedListener);		
		addView(years);		
		
		months = new WheelView(context);
		LayoutParams lparams_month = new LayoutParams(mWidth,LayoutParams.WRAP_CONTENT);
		lparams_month.setMargins(0, 0, 20, 0);
		...
		days.setLayoutParams(new LayoutParams(mWidth,LayoutParams.WRAP_CONTENT));
	...
	private OnWheelChangedListener onYearsChangedListener = new OnWheelChangedListener(){
		...
		public void onChanged(WheelView hours, int oldValue, int newValue) {
			calendar.set(Calendar.YEAR, currentyear + newValue);	
